...
<table>
 ...
 <tbody>
   ...
   <tr>
     ...
     <td></td>
     <td>String</td>
     <td>The custom JSON format schema is compatible with single quote and double quote modes. When using Spark-SQL, the single quote mode does not need to escape double quotes, which is more convenient.
     <ul>
